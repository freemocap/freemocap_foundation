...
And yet we are a species of explorers and we are drawn to those dark spaces. Each new generation of scientist builds new tools for their exploration; most dig down within their specialized niche, but some brave few build outwards towards the distant glowing shapes in the fog. Some of those even succeed, building new intergrations of previously disjointed theory - shedding light on new territory and the promise of new science at the intersections between deep domains of existing knowledge. But the discoverer cannot stay there. As reward for their success, they are bundled up and shipped around the world to start fresh in a new lab with a rubber stamp on their forehead that reads #smallcaps(This One Knows Neuroscience). [TODO - this could be cleaned up and made punchier and cleaner, i think]
