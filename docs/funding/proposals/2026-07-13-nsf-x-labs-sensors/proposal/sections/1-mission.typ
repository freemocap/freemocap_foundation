...
We ground our development of the #smallcaps[Dome] and its variants through a novel _calculus of sensor-grounded observation_, a formal system for tracing uncertainty across converging cascades of infernence, computation, calibration, and fusing as signals from heterogenous sensors for measuring the *body*, *eyes*, and *environment* of freely moving organisms converge into 
