...
commensurable rather than merely co-recorded. The term "Complete" is intentionally aspirational; a dream of perfect Knowledge as we compose our own limited set of imperfect transducers to fan-in metrologically-traceable pipelines from hetereogenous sensors into a single fitted model.
...
clock, its uncertainty, and its semantic identity intact, so that a gaze
