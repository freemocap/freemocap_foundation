...
We will organize our technical development around the technical bottlenecks which limit our ability to combine reconstructions the *eye*, *body*, and *environment* into combined represetations whch trace to activity in the central and peripheral nervous system, tagetting development effort on the target of tracking the body, eye, and world with sufficient precision and accuracy so that the retina-projected real-world stimulus is reliable enough to be targetted by cortical measurements in animal models, and body kinematics and kinetics are reliable enough so that surface electrode measures validate full-body muscuskeletal activation models (e.g. via OpenSim or similar). 
