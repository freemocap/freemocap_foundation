...
*Michael Nguyen — Project Manager, DOME-L.* Clinical biomechanics, medical-systems design, mechatronics, and multi-modal mocap-lab management; holds the skillset for large-scale DOME-L facility design and operation. <skp-MN>
