--
NOTE - text in quote blocks (starting wtih `> `) are either instructions from the form, or voice transcriptions of the KIND of text vibe we are going for. This whole document is a sloppy early work in progress and shouldnt be taken seriously
--
...
> The history of human intelligence is the history of tool building. And we can do better than what we currently have available. We know how to build better software, but the systems of research and science that exist don't allow us to build the things that we could build [ETC ETC]. 
