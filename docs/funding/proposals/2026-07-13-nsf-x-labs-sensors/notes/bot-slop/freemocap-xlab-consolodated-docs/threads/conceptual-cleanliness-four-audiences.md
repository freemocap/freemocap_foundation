...
A **[[sensor-grounded-ontology|sensor-grounded ontology]]** is not just a data model — its *conceptual cleanliness* pays off simultaneously across four audiences. The strategic point is the **multiplicity**: one investment, four returns. `#design-lesson`
