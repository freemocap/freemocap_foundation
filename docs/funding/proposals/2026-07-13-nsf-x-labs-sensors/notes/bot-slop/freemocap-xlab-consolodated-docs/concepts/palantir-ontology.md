...
> Mistake — adopting shared standards ([[lab-streaming-layer|LSL]] etc.) too early leads to problems; [[worse-is-better|build to spec, standardize later]] instead. See [[traps-and-anitpatterns]].
