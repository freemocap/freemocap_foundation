---
tags: [concept, x-labs, thesis, reframe]
aliases: [Three Load-Bearing Questions, the three questions]
type: concept
---

# The Three Load-Bearing Questions

Everything in the proposal should be answerable to these three. If a sentence doesn't serve one of them, question it.
...
> [!tip] The single reframing that is "the whole ballgame" `#reframe`
> The proposal must read as **a new instrument that unlocks a new science, not as infrastructure that makes existing science more convenient.**

**Related:** [[nsf-x-labs-opportunity-and-fit]] · [[the-software-exclusion]] · [[complete-empirical-capture]] · [[the-thesis-instrument-not-software]]
