---
tags: [integrative, architecture, ontology, reusable-pattern, precedent, proof-at-scale, framing-hazard]
...
The engineering credibility of the whole vision comes from a single observation: **[[palantir-ontology|Palantir]] and [[anduril-lattice|Anduril]] built, for enterprise and defense, exactly the middle layer that behavioral science lacks** — and the mapping to science is unusually clean, which is what makes the analogy more than rhetorical.

> [!warning] Framing hazard `#framing-hazard`
> This paradigm is a **strength when it supplies architecture** and a **liability if it makes the work *sound* like enterprise/defense software** ([[the-software-exclusion]]). Use it for engineering credibility; keep the surface framing on **measurement**. See [[say-vs-allude]].
...
**Related:** [[palantir-ontology]] · [[anduril-lattice]] · [[maven-smart-system]] · [[the-missing-middle]] · [[composition-over-inheritance]] · [[entity-component-system]] · [[build-to-spec-vs-shared-protocols]]
