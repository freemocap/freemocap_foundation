...
== Team Qualifications
The FreeMoCap Foundation team combines two decades of the PI's research experience in camera-based measurement of human perceptuo-motor behavior with nearly a decade of the co-PI's, whose doctoral dissertation is the development and validation of the FreeMoCap system itself #c("cherianOpensourceDevelopmentValidation2026"). The team has built, validated, distributed, and supported FreeMoCap and its community for more than five years, carrying it from a single-laboratory side project to an instrument used in 153 countries, and has managed the technical and organizational challenges that growth produced.
