...
// SOFT-TOUCH: this subsection IS the scope-creep answer from your note at the
// top of the file, but never says so. Cheapest fix is a subordinate clause on
// the sentence below — extensions let the core stay small while the ecosystem
// grows — which connects it back to §1's federation frame without adding a
// sentence. Yours to phrase; flagging rather than drafting it.
...
// -----------------------------------------------------------------------------
// STILL OPEN (2026-08-30) — the only section whose closing-output sentence is
// unwritten. Must correspond to a row in the §7 milestone table.
