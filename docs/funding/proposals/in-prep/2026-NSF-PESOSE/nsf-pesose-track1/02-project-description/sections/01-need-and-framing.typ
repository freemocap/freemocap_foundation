...
FreeMoCap #c("queenFreeMoCapFreeOpen2024") is a free and open-source markerless motion capture software system that produces research-grade full body kinematic data from generic cameras (@fig-overview). Built and maintained by the FreeMoCap Foundation since 2021, it has grown organically into a vibrant, successful project with nearly 10,000 GitHub stars, telemetry indicating more than 15,000 users across 153 countries, and a global community forum of over 4,000 students, researchers, educators, and artists.
...
Despite this growth, our understanding of the broader FreeMoCap community remains limited. Telemetry and interactions with users who participate in public forums do not reliably tell us who our users are, what they need, or where existing technical and community infrastructure creates barriers. 
